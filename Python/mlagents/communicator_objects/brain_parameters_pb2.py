...
_BRAINPARAMETERSPROTO = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mmf_offset_fitness', full_name='communicator_objects.BrainParametersProto.mmf_offset_fitness', index=8,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='mmf_size_fitness', full_name='communicator_objects.BrainParametersProto.mmf_size_fitness', index=9,
...
BrainParametersProto = _reflection.GeneratedProtocolMessageType('BrainParametersProto', (_message.Message,), {
  ...
  '__module__' : 'files.brain_parameters_pb2'
