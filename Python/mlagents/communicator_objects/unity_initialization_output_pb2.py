...
_UNITYINITIALIZATIONOUTPUTPROTO.fields_by_name['brain_parameters'].message_type = files_dot_brain__parameters__pb2._BRAINPARAMETERSPROTO
...
UnityInitializationOutputProto = _reflection.GeneratedProtocolMessageType('UnityInitializationOutputProto', (_message.Message,), {
  ...
  'DefaultResetParametersEntry' : _reflection.GeneratedProtocolMessageType('DefaultResetParametersEntry', (_message.Message,), {
    ...
    '__module__' : 'files.unity_initialization_output_pb2'
...
_UNITYINITIALIZATIONOUTPUTPROTO_DEFAULTRESETPARAMETERSENTRY._options = None
